...
4. **PrefixSums**: Draw the solution to understand if prefix sums would work or not
   ...
   * Might need to do some algebra instead of drawing with some base case [LC 523](https://github.com/KaranBulani/leetcode_practise/blob/python/ArrHash%20523%20Continuous%20Subarray%20Sum/Solution.py)
---
