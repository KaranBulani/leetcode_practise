...
if __name__ == "__main__":
    ...
    print("Test 1:", result)  # Expected: [4,2,7,1,3,5]
    ...
    val = 25
    result = solution.insertIntoBST(root, val)
    print("Test 2:", result)  # Expected: [40,20,60,10,30,50,70,null,null,25]
    ...
    val = 5
    result = solution.insertIntoBST(root, val)
    print("Test 3:", result)  # Expected: [4,2,7,1,3,5]

    # Edge Case 1: Empty tree
    root = None
    val = 10
    result = solution.insertIntoBST(root, val)
    print("Edge Case 1:", result)  # Expected: [10]

    # Edge Case 2: Insert as leftmost child
    root = TreeNode(10, TreeNode(5), TreeNode(15))
    val = 1
    result = solution.insertIntoBST(root, val)
    print("Edge Case 2:", result)  # Expected: node 1 gets inserted left of 5

    # Edge Case 3: Insert as rightmost child
    root = TreeNode(10, TreeNode(5), TreeNode(15))
    val = 20
    result = solution.insertIntoBST(root, val)
    print("Edge Case 3:", result)  # Expected: node 20 gets inserted right of 15
    ...
    val = 11
    result = solution.insertIntoBST(root, val)
    print("Edge Case 4:", result)  # Expected: node 11 goes as left child of 12’s right (14)
