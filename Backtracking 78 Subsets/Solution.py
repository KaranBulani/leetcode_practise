...
└──i=2── [3] <── backtrack(3,[3]) ──> For loop call 3rd
         └── (Returns)
                        ...
                        ┌───────────────────────┬───┴────────────┬───────────────┐
                        │                       │                │               │
for in range           0,3                     1,3              2,3             3,3                 Here start was 0 for all
                       [1]                     [2]              [3]            (done)
                   ┌────┴────┐──────┐         ┌──┴───┐            │
                   │         │      │         │      │            │
for in range      1,3       2,3    3,3       2,3    3,3          3,3                                Here start was 1,2,3
                 [1,2]     [1,3]  (end)     [2,3]  (end)        (end)
                   │         │               │
for in range      2,3       3,3             3,3                                                     Here start was 2,3
                [1,2,3]    (end)           (end)
                   │
                  3,3                                                                               Here start was 3
                 (end)
